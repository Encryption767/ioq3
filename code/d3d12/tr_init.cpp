...
void ( WINAPIV *qglActiveTextureARB )( GLenum texture );
void ( WINAPIV *qglClientActiveTextureARB )( GLenum texture );

void ( WINAPIV *qglLockArraysEXT )( GLint, GLint );
void ( WINAPIV *qglUnlockArraysEXT ) ( void );
...
static void InitRenderAPI(void) {
	...
	// Swap to an SDL window so we can have input as normal
	GLimp_SwitchSDL();
...
void RE_Shutdown(qboolean destroyWindow) {
	...
	// Cleanup any SDL stuff
	GLimp_ShutdownSDL(destroyWindow);
